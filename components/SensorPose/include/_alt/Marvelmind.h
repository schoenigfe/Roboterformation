...
class Marvelmind : public KalmanSensor, public SensorPose
{
    public:
        ...
        bool getQual(ros_msgs::Qual& current_qual) const; override;     
        bool peekAtQual(ros_msgs::Qual& current_qual) const; override;     
        bool peekAtImu(ros_msgs_lw::Imu& current_imu) const; override;       
