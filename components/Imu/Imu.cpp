 ...
 */
esp_err_t Imu::mpu9250_register_read(uint8_t reg_addr, uint8_t *data, size_t len)
{
 ...
 */
esp_err_t Imu::mpu9250_register_write_byte(uint8_t reg_addr, uint8_t data)
{
    int ret;
 ...
 */
esp_err_t Imu::i2c_master_init(void)
{
